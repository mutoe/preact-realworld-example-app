...
import { deleteFavoriteArticle, deleteFollowProfile, postFavoriteArticle, postFollowProfile } from 'public/services'
import { DEFAULT_AVATAR } from 'public/store/constants'
import { dateFilter } from 'public/utils/filters'
...
const ArticleMeta: FunctionComponent<ArticleMetaProps> = (props) => {
  ...
  return (
    <div className="article-meta">
      <a href={`/@${article.author.username}`}><img src={article.author.image || DEFAULT_AVATAR} alt=""/></a>
      <div className="info">
